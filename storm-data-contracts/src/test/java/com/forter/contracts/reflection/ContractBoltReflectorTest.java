...
public class ContractBoltReflectorTest {
    ...
    public void testNotNullContract() {
        ContractBoltReflector reflector = new ContractBoltReflector(new MockContractsBolt(true));
    ...
    public void testOptionalContract() {
        ContractBoltReflector reflector = new ContractBoltReflector(new MockOptionalContractsBolt(true));
    ...
    public void testCollectionContract() {
        ContractBoltReflector reflector = new ContractBoltReflector(new MockCollectionContractsBolt(true));
